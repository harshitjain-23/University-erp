...
<form action="" method="POST">
    <fieldset>
        ...
        <input type="email" id="mail" name="Mail" placeholder="example@gmail.com" value="<?php echo htmlspecialchars($gmail); ?>" required><br>
        ...
        <input type="text" id="joining" name="Jyear" value="<?php echo htmlspecialchars($joinyear); ?>" required><br>
        
        <label for="sal">Salary</label><br>
        <input type="text" id="sal" name="Sal" value="<?php echo htmlspecialchars($sal); ?>"><br>
